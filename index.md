...
longitude: "-93.129855"       # decimal longitude of the workshop venue (use https://www.latlong.net)
...
instructor: ["Amy Kendig", "Véronique St-Louis", "Dave Staples", "Chris Jennelle", "David Wilson"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Melissa Boman", "Katelin Goebel", "Deanna Leigh"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p id="requirements">
  ...
  {% if online == "false" %}
    In-person participants must bring a laptop and <strong>a lunch</strong> (no nearby restuarants). All participants must have access to a computer with a
...
<p>If you have issues during the download, please contact MNIT. If you have issues with the steps after download, please contact Amy Kendig at amy.kendig@state.mn.us or through a Teams message.</p>
<p>
